...
public class Canvas
{
    ...
    // Implementación del método drawString
    public void drawString(String string, int x, int y) {
        graphic.setColor(Color.black); // Color del texto
        graphic.drawString(string, x, y); // Dibuja el texto en la posición especificada
        canvas.repaint(); // Actualiza el lienzo para mostrar el texto
    }
